...
- **Custom Scripts**: In some cases an external inventory has its own data model. The script source can be used to map the external inventory-specific model into the OpenNMS requisition model.
