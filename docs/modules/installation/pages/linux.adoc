...
To install {page-component-title} on your Linux system you have to install a current Java Runtime Environment link:http://openjdk.java.net[OpenJDK 21] or link:https://developer.oracle.com/java[Oracle 21 JRE].
