...
To install {page-component-title} on your Linux system you have to install a current Java Runtime Environment link:http://openjdk.java.net[OpenJDK 25] or link:https://developer.oracle.com/java[Oracle 25 JRE].

Download and extract the latest stable release from link:https://github.com/OpenNMS/opennms-provisioning-integration-server/releases/latest[GitHub] or use the curl commands below to grab the latest release in your shell.
