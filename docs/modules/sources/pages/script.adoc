...
By default Groovy 4 and BeanShell 2.0b6 are ready to use. If you want to use other supported languages, you might need to provide the language jar in the `lib` folder of _PRIS_.
...
[source,bash]
----
include::example$script/requisitions/myGroovySource/requisition.properties[]
----
