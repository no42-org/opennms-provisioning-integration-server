...
public class RequisitionProviderHandler extends Handler.Abstract {
    ...
    public boolean handle(final Request request,
        ...
        // The path is relative to the "/requisitions" context; strip the
        // leading slash and take the first segment as the instance name.
        final String pathInContext = Request.getPathInContext(request);
        final String[] pathParts = pathInContext.replaceFirst("^/", "").split("/");
        ...
        try {
            ...
            // Marshall the requisition and write it to the response output stream
